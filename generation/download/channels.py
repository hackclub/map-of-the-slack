...
def download_channels():
	...
	with click.progressbar(length=1000, label="Downloading public Slack channels...") as bar:
		currentConversationsRes = client.conversations_list(limit=1000, types='public_channel')
	...
	with click.progressbar(length=1000, label="Downloading private Slack channels...") as bar:
		currentConversationsRes = client.conversations_list(limit=1000, types='private_channel')
